...
def main():
    ...
    s2 =('''Our first location here is the Murray Student Center. This location   
...
the campus post office, and the campus bookstore.''')
    ...
    print()
    d1 = "Donnelly Hall"
    d2 = ('''Our next location here is Donnelly Hall. This location mainly houses
...
and the Computer Lab.''')
    ...
    print()
    h1 = "Hancock Center"
    h2 = ('''Our next location here is the Hancock Center. This location is
...
and our Center for Teaching Excellence.''')
    ...
    print()
    m1 = "McCann Center"
    m2 = ('''Our next location here is the McCann Center. This location is mostly
...
for people who come to visit our campus.''')
    ...
    c2 = ('''Our next location here is the Cannavino Library. This location serves
...
Affairs, and our Digital Education services.''')
    ...
    print()
    ch1 = "The Chapel"
    ch2 = ('''Our next location here is the Chapel. The Chapel serves as an
...
12 pm and 6:30 pm.''')
    ...
    print()
    mc1 = "McCormick Hall"
    mc2 = ('''Our next location here is McCormick Hall. This location serves as a
...
known as North End Dining.''')
    ...
    sp2 = ('''Our next location is the Steel Plant Studios and Gallery, commonly
...
here as well.''')
    ...
    sc2 = ('''Our next location here is the Science and Allied Health Building.
...
the medical field will likely take most of their classes here.''')
    ...
    print()
    dy1 = "Dyson Center"
    dy2 = ('''Our last location that I will be showing you here at Marist College
